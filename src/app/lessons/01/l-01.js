...
// Answer:  Use the 'use strict' on the beginning of script

// Task 01.03 - 2 points
// Q: What simple data types are used in JS?
// A: Simple Data Types: Boolen, Number, String, Null, Undefined

// Task 01.04 - 2 points
// Q: What complex data types are used in JS?
// A: Complex Data types: Object (includes functions)
...
function diffNum(a, b){
    if (!isNaN(+a) && !isNaN(+b)){  // check for valid input
        var diff = Math.abs(a - b);
        return diff == 0 ?  console.log("The numbers are equal!") : console.log("The difference between two numbers is " + diff);
    } else {    
        return console.log("Please put correct data. The parameters shoul be the numbers")
    }
}
